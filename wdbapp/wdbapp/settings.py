"""
Django settings for wdbapp project.
...
SECRET_KEY = 'django-insecure-oduczf-zs0r#4va=^l5l_ocg%)6$hz4$j45c@14h3iskgcqr52'
...
WSGI_APPLICATION = 'wdbapp.wsgi.application'
